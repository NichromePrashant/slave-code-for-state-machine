...
#define CAN_RSK_8MHZ_XTAL_500KBPS_PRESCALER     (2)       /* 2,1 */
#define CAN_RSK_8MHZ_XTAL_500KBPS_TSEG1         (5)      /* 5,10 */
#define CAN_RSK_8MHZ_XTAL_500KBPS_TSEG2         (2)       /* 2,5 */
#define CAN_RSK_8MHZ_XTAL_500KBPS_SJW           (1)       /* 1,1 */
