...
#define BSP_CFG_MCU_PART_PACKAGE        (0x6) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_MOSC_WAIT_TIME          (0x00) /* Generated value. Do not edit this manually */
