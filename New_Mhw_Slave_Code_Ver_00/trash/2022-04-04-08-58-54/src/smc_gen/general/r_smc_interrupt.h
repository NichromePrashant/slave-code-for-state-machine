...
#define ICU_CMT0_CMI0_PRIORITY                     (_0D_ICU_PRIORITY_LEVEL13)
#define ICU_CMT1_CMI1_PRIORITY                     (_0C_ICU_PRIORITY_LEVEL12)
#define ICU_CMT2_CMI2_PRIORITY                     (_0B_ICU_PRIORITY_LEVEL11)
#define ICU_CMT3_CMI3_PRIORITY                     (_0B_ICU_PRIORITY_LEVEL11)
...
#define ICU_CAN_COMFRXINT_PRIORITY                 (_0E_ICU_PRIORITY_LEVEL14)
#define ICU_CAN_RXFINT_PRIORITY                    (_0E_ICU_PRIORITY_LEVEL14)
#define ICU_CAN_TXINT_PRIORITY                     (_0E_ICU_PRIORITY_LEVEL14)
#define ICU_CAN_CHERRINT_PRIORITY                  (_0E_ICU_PRIORITY_LEVEL14)
#define ICU_CAN_GLERRINT_PRIORITY                  (_0E_ICU_PRIORITY_LEVEL14)
...
#define ICU_MTU0_TGIA0_PRIORITY                    (_0D_ICU_PRIORITY_LEVEL13)
#define ICU_MTU0_TGIB0_PRIORITY                    (_0D_ICU_PRIORITY_LEVEL13)
#define ICU_MTU0_TGIC0_PRIORITY                    (_0D_ICU_PRIORITY_LEVEL13)
#define ICU_MTU0_TGID0_PRIORITY                    (_0D_ICU_PRIORITY_LEVEL13)
